...
There are several alternative options to install mofaflex-counselor:

<!--
1) Install the latest release of `mofaflex-counselor` from [PyPI][]:

```bash
pip install mofaflex-counselor
```
-->
...
```bash
pip install git+https://github.com/biofam/mofaflex-counselor.git@main
```
